...
public class ConvenioController {
    ...
    @PostMapping
    public ResponseEntity<ConvenioDto> saveConvenio(@RequestBody ConvenioCreateRequest convenioRequest) {
        ConvenioDto savedConvenio = convenioService.save(convenioRequest);
